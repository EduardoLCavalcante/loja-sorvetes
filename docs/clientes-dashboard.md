...
2. Em seguida, aplique `supabase/migrations/20260716_add_order_house_number.sql`, `supabase/migrations/20260716_optimize_dashboard_customer_history.sql` e `supabase/migrations/20260717_add_delivery_zones.sql`.
...
- Bairros e taxas são gerenciados pela seção **Entregas** da dashboard; somente bairros ativos ficam disponíveis no checkout.
