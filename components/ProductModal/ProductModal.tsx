...
const ProductModal = (props: PropsProducsModal) => {        
                ...
                <>
                  <DialogHeader className="px-6 pt-6">
                    <DialogTitle className="text-2xl md:text-3xl">
                      {productModal.nome_exibicao || props.formatProductName(productModal.nome_produto)}
                    </DialogTitle>
                      ...
                      {!modalImageError ? (
                        <Image
                          src={
                            ...
                            "/placeholder.svg"
                           || "/placeholder.svg"}
                          alt={productModal.nome_exibicao || props.formatProductName(productModal.nome_produto)}
                          width={800}
                          height={800}
                          unoptimized
                    ...
                    <div className="flex flex-col">
                      <div className="mb-3">
                        <Badge variant="outline" className="text-pink-600 border-pink-200">
                          {props.formatCategoryName(productModal.categoria)}
                        </Badge>
                      </div>
    
                      <p className="text-gray-700 leading-relaxed mb-6">
                        {productModal.descricao ||
                          `Delicioso ${productModal.nome_exibicao || props.formatProductName(productModal.nome_produto)} feito com ingredientes premium selecionados.`}
                      </p>
                      ...
                      <div className="mt-auto">
                        ...
                        <div className="flex gap-3">
                          <Button
                            onClick={() => {
                              props.handleAddToCart(productModal)
                            }}
